...
if "Facebook" in driver.title:
    ...
    # URL of the Facebook profile page you want to access
    url = 'https://mbasic.facebook.com/profile.php?eav=AfblFcfuaC8WlY5JA5N3ie6Jpcq7bpOANTO_wzL1Cxj9EDH1MfxIDoZz8geGIG06L7s&refid=7&paipv=0&_rdr'
    driver.get(url)

    # ค้นหา textarea และกรอกข้อความ
    textarea = driver.find_element(By.CSS_SELECTOR, 'textarea[name="xc_message"]')
    textarea.send_keys('ข้อความที่คุณต้องการโพสต์')

    # ค้นหาปุ่มโพสต์และคลิก
    post_button = driver.find_element(By.CSS_SELECTOR, 'input[name="view_post"]')
    post_button.click()
else:
    print("Login failed")
